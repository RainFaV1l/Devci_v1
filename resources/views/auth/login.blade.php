    ...
    <section class="auth">
        <div class="auth-wrapper">
            ...
            <div class="auth__info">
                ...
                <div class="account-create">Нет профиля? Скорей <a href="{{'/register'}}">создавай</a>, это бесплатно!</div>
                ...
                @endif
                <form class="auth-form" method="POST" novalidate action="{{ route('login') }}">
                    @csrf
                    <input type="text" name="email" class="input" placeholder="Email" value="{{old('email')}}" required autofocus>
