                ...
                <div class="form__item">
                    <div class="error__input-column">
                        <div class="input-column @error('surname') error @enderror">
                            <input wire:ignore wire:model="surname" class="input" id="profile-surname" type="text"
                                required autofocus>
                ...
                <div class="form__item">
                    <div class="error__input-column">
                        <div class="input-column @error('name') error @enderror">
                            <input wire:ignore wire:model="name" class="input" id="profile-name" type="text"
                                required autofocus>
                ...
                <div class="form__item">
                    <div class="error__input-column">
                        <div class="input-column @error('patronymic') error @enderror">
                            <input wire:ignore wire:model="patronymic" class="input" id="profile-patronymic"
                ...
                <div class="form__item">
                    <div class="error__input-column">
                        <div class="input-column @error('birthday_date') error @enderror">
                            <input wire:ignore wire:model="birthday_date" class="input" id="profile-birthday"
                                type="date" min="1950-01-01" max="2023-01-01" required autofocus>
