<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Surname -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="surname" value="{{ __('Фамилия') }}" />
        ...
        <!-- Patronymic -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="patronymic" value="{{ __('Фамилия') }}" />
            <x-jet-input id="patronymic" type="text" class="mt-1 block w-full" wire:model.defer="state.patronymic" autocomplete="patronymic" />
            <x-jet-input-error for="patronymic" class="mt-2" />
        </div>
