                ...
                <div class="admin-panel-content__content">
                    <div class="admin-panel-content-aside__header admin-panel-content-aside-header">
                        <div class="admin-panel-content-aside-header__container">
                            ...
                            <p class="admin-panel-content-aside-header__subtitle">Информация о пользователях</p>
                            ...
                            <div class="admin-panel-info-new-users__container">
                                <div class="admin-panel-info-new-users__header">
                                    ...
                                    <div class="admin-panel-info-new-users__buttons">
                                        <a href="#" class="admin-panel-info-new-users__button active">Все</a>
                                        <a href="#" class="admin-panel-info-new-users__button">Новые</a>
                                        <a href="#" class="admin-panel-info-new-users__button">Без курса</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="admin-panel-info-new-users__table new-users-table">
                                        ...
                                        @foreach($users as $user)
                                            <div class="new-users-table__item">
                                                <p class="new-users-table__name new-users-table__id">{{ $user['id'] }}</p>
                                                ...
                                                <p class="new-users-table__name new-users-table__email">{{ $user['email'] }}</p>
                                                <p class="new-users-table__name">@if(trim($user->group, '[]')) {{ $user->group }} @else Без группы @endif</p>
                                                <p class="new-users-table__name">{{ $user->role->name }}</p>
