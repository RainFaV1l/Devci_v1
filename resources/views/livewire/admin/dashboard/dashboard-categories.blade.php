                            ...
                            <div class="admin-panel-info-new-users__container">
                                <div class="admin-panel-info-new-users__header">
                                    ...
                                    <div class="admin-panel-info-new-users__buttons">
                                        <a href="{{ route('courses.categoryAddView') }}" class="admin-panel-info-groups__button">Добавить категорию</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="admin-panel-info-new-users__table new-users-table">
                                        ...
                                        @foreach($categories as $category)
                                            <div class="new-users-table__item">
                                                <p class="new-users-table__name new-users-table__id">{{ $category['id'] }}</p>
                                                <p class="new-users-table__name">{{ $category['name'] }}</p>
                                                <p class="new-users-table__name">{{ $category['created_at'] }}</p>
                                                <p class="new-users-table__name">{{ $category['updated_at'] }}</p>
