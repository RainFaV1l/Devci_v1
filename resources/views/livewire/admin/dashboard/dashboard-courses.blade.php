                                ...
                                <div class="admin-panel-info-new-users__header">
                                    ...
                                    <form action="" class="admin-panel-info-new-users__form">
                                        ...
                                        <button type="submit">
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                                ...
                                                <circle cx="6.5" cy="6.5" r="5.75" stroke="#1D1D39"
                                                    stroke-opacity="0.6" stroke-width="1.5" />
                                                <line x1="11.0607" y1="11" x2="16" y2="15.9393"
                                                    stroke="#1D1D39" stroke-opacity="0.6" stroke-width="1.5"
                                    ...
                                    <div class="admin-panel-info-new-users__buttons">
                                        <a href="{{ route('courses.add') }}"
                                            class="admin-panel-info-groups__button">Добавить курс</a>
                                    </div>
                                </div>
                                <div class="users-table">
                                    <div class="admin-panel-info-new-users__table new-users-table">
                                        <div class="new-users-table__item new-users-table__header">
                                            ...
                                            <p class="new-users-table__name">Цена</p>
                                            <p class="new-users-table__name new-users-table__email">Автор</p>
                                            <p class="new-users-table__name">Категория</p>
                                            <p class="new-users-table__name">Дата создания</p>
                                            <p class="new-users-table__name">Дата изменения</p>
                                        ...
                                        @foreach ($courses as $course)
                                            <div class="new-users-table__item">
                                                <p class="new-users-table__name new-users-table__id">{{ $course['id'] }}</p>
                                                <p class="new-users-table__name">{{ $course['name'] }}</p>
                                                <p class="new-users-table__name">{{ $course['price'] }}</p>
                                                <p class="new-users-table__name new-users-table__email">
                                                    {{ App\Models\User::getFioShort($course->author()->surname, $course->author()->name, $course->author()->patronymic) }}
                                                </p>
                                                <p class="new-users-table__name">
                                                    {{ $course->category->name }}
                                                </p>
                                                <p class="new-users-table__name">{{ $course['created_at'] }}</p>
                                                <p class="new-users-table__name">{{ $course['updated_at'] }}</p>
