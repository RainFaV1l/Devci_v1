                        ...
                        <div class="admin-panel-info__new-users admin-panel-info-new-users admin-panel-info-users">
                            <div class="admin-panel-info-new-users__container">
                                ...
                                <div class="users-table">
                                    <div class="admin-panel-info-new-users__table new-users-table courses-table">
                                        <div class="new-users-table__item new-users-table__header">
                                            ...
                                            <p
                                                class="new-users-table__name admin-control__buttons courses-buttons admin-control__hide">
                                        ...
                                        @livewire('dashboard.course-show')
                                    </div>
                                </div>
                            </div>
                        </div>
