...
{{--                        </div>--}}
                        ...
                        <input wire:model="price" type="text" name="price" class="add-course-form__input" placeholder="Цена">
                        @error('price') {{ $message }} @enderror
                        <input wire:model="author" type="text" name="author" class="add-course-form__input" placeholder="Автор">
                        @error('author') {{ $message }} @enderror
                        <select wire:model="course_category_id" name="course_category_id" class="add-course-form__input add-course-form__select">
                        ...
                        <textarea wire:model="description" name="description" placeholder="Введите описание..." class="add-course-form__input add-course-form__textarea"></textarea>
                        @error('description') {{ $message }} @enderror
                        <div class="add-course-form__img add-course-form-img dragable-img">
                            <input wire:model="course_icon_path" id="dragImg" type="file" name="course_icon_path" multiple class="hidden add-course-form-img__img drag-img" draggable="true">
                            ...
                            @error('course_icon_path') <span class="error">{{ $message }}</span> @enderror
                        </div>
                        <div class="add-course-form__img add-course-form-img dragable-img">
                            <input wire:model="course_banner_path" id="dragImg2" type="file" name="course_banner_path" multiple class="hidden add-course-form-img__img drag-img" draggable="true">
                            ...
                            @error('course_banner_path') <span class="error">{{ $message }}</span> @enderror
                        </div>
