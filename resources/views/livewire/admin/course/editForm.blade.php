<form method="post" wire:submit.prevent="update({{ $course['id'] }})" enctype="multipart/form-data">
    ...
    <div class="add-course-form__img add-course-form-img dragable-img">
        <input wire:model="course_icon_path" id="dragImg" type="file"
               class="hidden add-course-form-img__img drag-img" draggable="true" name="course_icon_path">
...
{{--    <img class="drag-img-styles" src= "{{ $course->banner_url }}" alt="image">--}}
{{--    <div class="add-course-form__img add-course-form-img dragable-img">--}}
{{--        <input wire:model="course_banner_path" id="dragImg2" type="file" name="course_banner_path"--}}
{{--               class="hidden add-course-form-img__img drag-img" draggable="true">--}}
