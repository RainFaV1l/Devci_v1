...
<div class="modal-burger">
    <div class="content">
        ...
        <div class="modal-burger__wrapper">
            ...
            <a href="#">О нас</a>
            <a href="#">Отзывы</a>
            <a href="#" class="button-account__modal">Войти</a>
        </div>
    </div>
</div>
<!--Фон для меню-->
        ...
        <header class="opacity-anim element-animation">
            <div class="container">
                <div class="head">
                    ...
                    <div class="nav">
                        <a href="/" class="nav__a">Главная</a>
                        <a href="/catalog" class="nav__a">Каталог</a>
                        <a href="#" class="nav__a">Преимущества</a>
                        <a href="#" class="nav__a">О нас</a>
                        <a href="#" class="nav__a">Отзывы</a>
                    </div>
                    <div class="account">
                        <a href="/login" class="button-account">Войти</a>
